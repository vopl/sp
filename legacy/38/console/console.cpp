...
#define TIMEBEG "2007-01-20 00:00:00"
#define TIMEEND "2009-10-31 00:00:00"

#define TIMESTEP (60*60*12)
...
int processOne(int pow)
{
	...
	if(!core->load(stateFileName.c_str()))
	{
		...
		ssd._zeroPeriod = (60*10);//60 сек
		ssd._smoothLength = 60;	//N по ssd._zeroPeriod
		


		hel::SettingsOptimizer so={};
		real mn=1*60*60;
		real mx=1*60*60*24*5*4*6;
		//////////////////////////////////////////////////////////////////////////
		so._minPeriodE = mn;
		so._maxPeriodE = mx;
		real mult = 0.95;

...
/*  -- LAPACK driver routine (version 3.1) --   
    ...
    static const doublereal c_b421 = 0.;
    static const doublereal c_b443 = 1.;
    ...
    char ch__1[2];
    /* Builtin functions   
       Subroutine */ int s_cat(const char *, const char **, const integer *, const integer *, const ftnlen);
    double sqrt(const doublereal);
    /* Local variables */
    _THREAD_STATIC_ integer i__, ie, ir, iu, blk, ncu;
    _THREAD_STATIC_ doublereal dum[1], eps;
    _THREAD_STATIC_ integer nru, iscl;
    _THREAD_STATIC_ doublereal anrm;
    _THREAD_STATIC_ integer ierr, itau, ncvt, nrvt;
    extern /* Subroutine */ int dgemm_(const char *, const char *, const integer *, const integer *, 
    ...
    _THREAD_STATIC_ integer chunk, minmn, wrkbl, itaup, itauq, mnthr, iwork;
    _THREAD_STATIC_ logical wntua, wntva, wntun, wntuo, wntvn, wntvo, wntus, wntvs;
    extern /* Subroutine */ int dgebrd_(const integer *, const integer *, const doublereal *, 
	    const integer *, const doublereal *, const doublereal *, const doublereal *, const doublereal *,
	     const doublereal *, const integer *, const integer *);
    extern doublereal dlamch_(const char *), dlange_(const char *, const integer *, 
	    const integer *, const doublereal *, const integer *, const doublereal *);
    _THREAD_STATIC_ integer bdspac;
    extern /* Subroutine */ int dgelqf_(const integer *, const integer *, const doublereal *, 
	    const integer *, const doublereal *, const doublereal *, const integer *, const integer *), 
	    dlascl_(const char *, const integer *, const integer *, const doublereal *, const doublereal *, 
	    const integer *, const integer *, const doublereal *, const integer *, const integer *),
	     dgeqrf_(const integer *, const integer *, const doublereal *, const integer *, 
	    const doublereal *, const doublereal *, const integer *, const integer *), dlacpy_(const char *,
	     const integer *, const integer *, const doublereal *, const integer *, const doublereal *, 
	    const integer *), dlaset_(const char *, const integer *, const integer *, 
	    const doublereal *, const doublereal *, const doublereal *, const integer *), 
	    dbdsqr_(const char *, const integer *, const integer *, const integer *, const integer *, 
	    const doublereal *, const doublereal *, const doublereal *, const integer *, const doublereal *,
	     const integer *, const doublereal *, const integer *, const doublereal *, const integer *), dorgbr_(const char *, const integer *, const integer *, const integer *, 
	    const doublereal *, const integer *, const doublereal *, const doublereal *, const integer *, 
	    const integer *);
    _THREAD_STATIC_ doublereal bignum;
    ...
    extern /* Subroutine */ int dormbr_(const char *, const char *, const char *, const integer *, 
	    const integer *, const integer *, const doublereal *, const integer *, const doublereal *, 
	    const doublereal *, const integer *, const doublereal *, const integer *, const integer *), dorglq_(const integer *, const integer *, const integer *, 
	    const doublereal *, const integer *, const doublereal *, const doublereal *, const integer *, 
	    const integer *), dorgqr_(const integer *, const integer *, const integer *, const doublereal *,
	     const integer *, const doublereal *, const doublereal *, const integer *, const integer *);
    _THREAD_STATIC_ integer ldwrkr, minwrk, ldwrku, maxwrk;
    _THREAD_STATIC_ doublereal smlnum;
    _THREAD_STATIC_ logical lquery, wntuas, wntvas;

...
int main(int argc, char *argv[])
{
    ...
    c->addScatterLayer(DoubleArray(dataX1, sizeof(dataX1)/sizeof(dataX1[0])),
        DoubleArray(dataY1, sizeof(dataY1)/sizeof(dataY1[0])), "Server BBB",
        Chart::TriangleSymbol, 9, 0x6666ff);

    // Add a trend line layer for (dataX1, dataY1)
    c->addTrendLayer(DoubleArray(dataX1, sizeof(dataX1)/sizeof(dataX1[0])),
        DoubleArray(dataY1, sizeof(dataY1)/sizeof(dataY1[0])), 0x6666ff
        )->setLineWidth(3);

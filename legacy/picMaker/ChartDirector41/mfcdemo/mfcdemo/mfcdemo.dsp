...
# ADD LINK32 ..\..\lib\chartdir41.lib /nologo /subsystem:windows /machine:I386
...
# ADD LINK32 ..\..\lib\chartdir41.lib /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept
# Begin Special Build Tool
OutDir=.\..\bin\Debug
SOURCE="$(InputPath)"
PostBuild_Desc=Copying ChartDirector DLL to output directory (if necessary)

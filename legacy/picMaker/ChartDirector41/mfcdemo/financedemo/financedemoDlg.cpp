...
void CFinancedemoDlg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Control(pDX, IDC_VGRID, m_VGrid);
...
BEGIN_MESSAGE_MAP(CFinancedemoDlg, CDialog)
    ...
    ON_WM_PAINT()
    ON_WM_QUERYDRAGICON()
    ON_CBN_SELCHANGE(IDC_TICKERSYMBOL, OnSelectChange)
    ...
    ON_BN_CLICKED(IDC_VGRID, OnSelectChange)
...
static const TCHAR *tickerSymbols[] =
{
    _T("9"), _T("Random Data 1"),
    _T("99"), _T("Random Data 2"),
    _T("999"), _T("Random Data 3"),
    _T("1"), _T("Random Data 4"),
    _T("11"), _T("Random Data 5"),
    _T("111"), _T("Random Data 6"),
    _T("5"), _T("Random Data 7"),
    _T("55"), _T("Random Data 8"),
    _T("555"), _T("Random Data 9"),
};
...
/// <param name="startDate">The starting date/time for the data series.</param>
/// <param name="endDate">The ending date/time for the data series.</param>
void CFinancedemoDlg::getWeeklyData(CString ticker, double startDate, double endDate)
{
    //
    // In this demo, we use a random number generator to generate the data. In practice,
...
void CFinancedemoDlg::generateRandomData(CString ticker, double startDate, double endDate, 
    int resolution)
{
    ...
    FinanceSimulator db((int)_tcstol(ticker, 0, 0), startDate, endDate, resolution);

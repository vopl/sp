...
ClarityResult_t
Clarity_FFT_R2C_double(
   int nx, int ny, int nz, double* in, double* out) {
   ...
   if (g_CUDACapable) {
    ...
    {
      fftw_complex* outComplex = (fftw_complex*) out;
      ...
      // reversed.
      fftw_plan plan = fftw_plan_dft_r2c_3d(nz, ny, nx, in, 
...
#endif
   {
      fftw_complex* inComplex = (fftw_complex*) in;

      // Holy smokes, I wasted a lot of time just to find that 
      // FFTW expects data arranged not in the normal way in 
      // medical/biological imaging. Dimension sizes need to be 
      // reversed.
      fftw_plan plan = fftw_plan_dft_c2r_3d(nz, ny, nx, 

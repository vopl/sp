...
/*  -- LAPACK routine (version 3.1) --   
    ...
    static const doublereal c_b15 = 1.;
    static const integer c__1 = 1;
    static const doublereal c_b29 = 0.;
    ...
    _THREAD_STATIC_ doublereal p, r__;
    _THREAD_STATIC_ integer z__, ic, ii, kk;
    _THREAD_STATIC_ doublereal cs;
    _THREAD_STATIC_ integer is, iu;
    _THREAD_STATIC_ doublereal sn;
    _THREAD_STATIC_ integer nm1;
    _THREAD_STATIC_ doublereal eps;
    _THREAD_STATIC_ integer ivt, difl, difr, ierr, perm, mlvl, sqre;
...
, doublereal *, integer *), dswap_(integer *, doublereal *, 
    ...
    _THREAD_STATIC_ integer poles, iuplo, nsize, start;
    ...
    _THREAD_STATIC_ integer givcol;
    extern doublereal dlanst_(char *, integer *, doublereal *, doublereal *);
    _THREAD_STATIC_ integer icompq;
    _THREAD_STATIC_ doublereal orgnrm;
    _THREAD_STATIC_ integer givnum, givptr, qstart, smlsiz, wstart, smlszp;

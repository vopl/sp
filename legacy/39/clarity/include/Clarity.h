...
C_FUNC_DEF
ClarityResult_t
Clarity_ImagePadSpatialShift(double *dst, Clarity_Dim3 dstDim, 
                             double *src, Clarity_Dim3 srcDim,
                             int shift[3], double fillValue);
...
C_FUNC_DEF
ClarityResult_t
Clarity_ImageClip(double *dst, Clarity_Dim3 dstDim, double *src, Clarity_Dim3 srcDim);
...
Clarity_SmoothedJansenVanCittertDeconvolve(
  ...
  double* kernelImage, Clarity_Dim3 kernelDim,
  double* outImage, unsigned iterations, unsigned smoothInterval,
  double* smoothSigma[3]);
...
C_FUNC_DEF
ClarityResult_t
Clarity_MaximumLikelihoodDeconvolve(double* inImage, Clarity_Dim3 imageDim,
				    double* kernelImage, Clarity_Dim3 kernelDim,
				    double* outImage, int iterations);
...
C_FUNC_DEF
ClarityResult_t
Clarity_BlindMaximumLikelihoodDeconvolve(double* outImage, double* inImage, double* psfImage,
...
C_FUNC_DEF
ClarityResult_t
Clarity_Convolve(double* inImage, Clarity_Dim3 imageDim,
		 double* kernel, Clarity_Dim3 kernelDim,
		 double* outImage);

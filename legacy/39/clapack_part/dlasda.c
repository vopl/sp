...
static const doublereal c_b11 = 0.;
	...
	doublereal *s, doublereal *work, integer *iwork, integer *info)
{
    ...
    /* Local variables */
    _THREAD_STATIC_ integer i__, j, m, i1, ic, lf, nd, ll, nl, vf, nr, vl, im1, ncc, 
	    nlf, nrf, vfi, iwk, vli, lvl, nru, ndb1, nlp1, lvl2, nrp1;
    _THREAD_STATIC_ doublereal beta;
    _THREAD_STATIC_ integer idxq, nlvl;
    _THREAD_STATIC_ doublereal alpha;
    _THREAD_STATIC_ integer inode, ndiml, ndimr, idxqi, itemp;
    extern /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    _THREAD_STATIC_ integer sqrei;
    ...
    _THREAD_STATIC_ integer nwork1, nwork2;
    ...
    _THREAD_STATIC_ integer smlszp;

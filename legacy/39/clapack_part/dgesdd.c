...
/*  -- LAPACK driver routine (version 3.1) --   
    ...
    static const doublereal c_b227 = 0.;
    static const doublereal c_b248 = 1.;
    ...
    /* Local variables */
    _THREAD_STATIC_ integer i__, ie, il, ir, iu, blk;
    _THREAD_STATIC_ doublereal dum[1], eps;
    _THREAD_STATIC_ integer ivt, iscl;
    _THREAD_STATIC_ doublereal anrm;
    _THREAD_STATIC_ integer idum[1], ierr, itau;
    extern /* Subroutine */ int dgemm_(char *, char *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, integer *);
    extern logical lsame_(char *, char *);
    _THREAD_STATIC_ integer chunk, minmn, wrkbl, itaup, itauq, mnthr;
    _THREAD_STATIC_ logical wntqa;
    _THREAD_STATIC_ integer nwork;
    _THREAD_STATIC_ logical wntqn, wntqo, wntqs;
    ...
    extern /* Subroutine */ int dormbr_(char *, char *, char *, integer *, 
	    ...
	    integer *), dorgqr_(integer *, integer *, integer *, doublereal *,
	     integer *, doublereal *, doublereal *, integer *, integer *);
    _THREAD_STATIC_ integer ldwrkl, ldwrkr, minwrk, ldwrku, maxwrk, ldwkvt;
    _THREAD_STATIC_ doublereal smlnum;
    _THREAD_STATIC_ logical wntqas, lquery;

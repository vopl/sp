...
static const doublereal c_b26 = 0.;
	...
	integer *idxc, integer *ctot, doublereal *z__, integer *info)
{
    ...
    /* Local variables */
    _THREAD_STATIC_ integer i__, j, m, n, jc;
    _THREAD_STATIC_ doublereal rho;
    _THREAD_STATIC_ integer nlp1, nlp2, nrp1;
    _THREAD_STATIC_ doublereal temp;
    extern doublereal dnrm2_(integer *, doublereal *, integer *);
    extern /* Subroutine */ int dgemm_(char *, char *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, integer *);
    _THREAD_STATIC_ integer ctemp;
    extern /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    _THREAD_STATIC_ integer ktemp;

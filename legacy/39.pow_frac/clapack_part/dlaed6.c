	...
	tau, integer *info)
{
    ...
    /* Local variables */
    _THREAD_STATIC_ doublereal a, b, c__, f;
    _THREAD_STATIC_ integer i__;
    _THREAD_STATIC_ doublereal fc, df, ddf, lbd, eta, ubd, eps, base;
    _THREAD_STATIC_ integer iter;
    _THREAD_STATIC_ doublereal temp, temp1, temp2, temp3, temp4;
    _THREAD_STATIC_ logical scale;
    _THREAD_STATIC_ integer niter;
    _THREAD_STATIC_ doublereal small1, small2, sminv1, sminv2;
    extern doublereal dlamch_(char *);
    _THREAD_STATIC_ doublereal dscale[3], sclfac, zscale[3], erretm, sclinv;

	...
	work, integer *info)
{
    ...
    _THREAD_STATIC_ doublereal dj, rho;
    _THREAD_STATIC_ integer iwk1, iwk2, iwk3;
    extern doublereal ddot_(integer *, doublereal *, integer *, doublereal *, 
	    integer *);
    _THREAD_STATIC_ doublereal temp;
    extern doublereal dnrm2_(integer *, doublereal *, integer *);
    _THREAD_STATIC_ integer iwk2i, iwk3i;
    _THREAD_STATIC_ doublereal diflj, difrj, dsigj;
    ...
    _THREAD_STATIC_ doublereal dsigjp;

...
/*  -- LAPACK routine (version 3.1) --   
    ...
    doublereal d__1;
    /* Local variables */
    _THREAD_STATIC_ integer j, k;
    _THREAD_STATIC_ doublereal ak, bk;
    _THREAD_STATIC_ integer kp;
    _THREAD_STATIC_ doublereal akm1, bkm1;
    extern /* Subroutine */ int dger_(integer *, integer *, doublereal *, 
	    doublereal *, integer *, doublereal *, integer *, doublereal *, 
	    integer *);
    _THREAD_STATIC_ doublereal akm1k;
    extern /* Subroutine */ int dscal_(integer *, doublereal *, doublereal *, 
	    integer *);
    extern logical lsame_(char *, char *);
    _THREAD_STATIC_ doublereal denom;

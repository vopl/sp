	...
	doublereal *work, integer *iwork, integer *info)
{
    ...
    /* Local variables */
    _THREAD_STATIC_ integer i__, k, n1, n2, is, iw, iz, iq2, ptr, ldq2, indx, curr;
    extern /* Subroutine */ int dgemm_(char *, char *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, integer *);
    _THREAD_STATIC_ integer indxc, indxp;
    extern /* Subroutine */ int dlaed8_(integer *, integer *, integer *, 
	    ...
	    *, doublereal *, integer *, doublereal *, doublereal *, integer *)
	    ;
    _THREAD_STATIC_ integer idlmda;
    extern /* Subroutine */ int dlamrg_(integer *, integer *, doublereal *, 
	    integer *, integer *, integer *), xerbla_(char *, integer *);
    _THREAD_STATIC_ integer coltyp;

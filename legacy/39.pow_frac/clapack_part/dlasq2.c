...
/*  -- LAPACK routine (version 3.1) --   
    ...
    /* Local variables */
    _THREAD_STATIC_ doublereal d__, e;
    _THREAD_STATIC_ integer k;
    _THREAD_STATIC_ doublereal s, t;
    _THREAD_STATIC_ integer i0, i4, n0;
    _THREAD_STATIC_ doublereal dn;
    _THREAD_STATIC_ integer pp;
    _THREAD_STATIC_ doublereal dn1, dn2, eps, tau, tol;
    _THREAD_STATIC_ integer ipn4;
    _THREAD_STATIC_ doublereal tol2;
    _THREAD_STATIC_ logical ieee;
    _THREAD_STATIC_ integer nbig;
    _THREAD_STATIC_ doublereal dmin__, emin, emax;
    _THREAD_STATIC_ integer ndiv, iter;
    _THREAD_STATIC_ doublereal qmin, temp, qmax, zmax;
    _THREAD_STATIC_ integer splt;
    _THREAD_STATIC_ doublereal dmin1, dmin2;
    _THREAD_STATIC_ integer nfail;
    _THREAD_STATIC_ doublereal desig, trace, sigma;
    _THREAD_STATIC_ integer iinfo, ttype;
    ...
    _THREAD_STATIC_ integer iwhila, iwhilb;
    _THREAD_STATIC_ doublereal oldemn, safmin;
    ...
    extern /* Subroutine */ int dlasrt_(const char *, const integer *, const doublereal *, 
	    const integer *);

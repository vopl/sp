...
my $minPeriod = 0*60*60;
my $maxPeriod = 999250*60*60;
...
my $periodTimeMult = "10.0000";
my $dir = "../out_small_$periodTimeMult/spectr1/";
#my $dir = "../out_small_$periodTimeMult/response/";
...
while(<INF>)
{
	...
	my $out = [$arr->[0]-$arr->[1]*$periodTimeMult, $arr->[1], $arr->[2], $arr->[3]];

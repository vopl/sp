...
static const doublereal c_b3 = -1.;
	...
	integer *info)
{
    ...
    _THREAD_STATIC_ integer k2, n2, ct, nj, pj, js, iq1, iq2, n1p1;
    _THREAD_STATIC_ doublereal eps, tau, tol;
    _THREAD_STATIC_ integer psm[4], imax, jmax;
    extern /* Subroutine */ int drot_(integer *, doublereal *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *);
    _THREAD_STATIC_ integer ctot[4];

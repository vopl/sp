...
/*  -- LAPACK routine (version 3.1) --   
    ...
    static const doublereal c_b21 = -1.;
    static const doublereal c_b22 = 1.;
    
    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2, i__3, i__4;
    /* Local variables */
    _THREAD_STATIC_ integer i__, j, nb, nx;
    _THREAD_STATIC_ doublereal ws;
    ...
    _THREAD_STATIC_ integer nbmin, iinfo, minmn;
    extern /* Subroutine */ int dgebd2_(const integer *, const integer *, const doublereal *, 
	    const integer *, const doublereal *, const doublereal *, const doublereal *, const doublereal *,
	     const doublereal *, const integer *), dlabrd_(const integer *, const integer *, const integer *
	    , const doublereal *, const integer *, const doublereal *, const doublereal *, const doublereal 
	    *, const doublereal *, const doublereal *, const integer *, const doublereal *, const integer *)
	    , xerbla_(const char *, const integer *);
    ...
    _THREAD_STATIC_ integer ldwrkx, ldwrky, lwkopt;

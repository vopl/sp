...
/*  -- LAPACK auxiliary routine (version 3.1) --   
    ...
    static const doublereal c_b5 = 1.;
    static const integer c__1 = 1;
    static const doublereal c_b16 = 0.;
    ...
    extern /* Subroutine */ int dscal_(const integer *, const doublereal *, const doublereal *, 
	    const integer *), dgemv_(const char *, const integer *, const integer *, const doublereal *, 
	    const doublereal *, const integer *, const doublereal *, const integer *, const doublereal *, 
	    const doublereal *, const integer *), dlarfg_(const integer *, const doublereal *,

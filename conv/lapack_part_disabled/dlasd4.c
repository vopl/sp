	...
	sigma, doublereal *work, integer *info)
{
    ...
    _THREAD_STATIC_ doublereal w, dd[3];
    _THREAD_STATIC_ integer ii;
    _THREAD_STATIC_ doublereal dw, zz[3];
    _THREAD_STATIC_ integer ip1;
    _THREAD_STATIC_ doublereal eta, phi, eps, tau, psi;
    _THREAD_STATIC_ integer iim1, iip1;
    _THREAD_STATIC_ doublereal dphi, dpsi;
    _THREAD_STATIC_ integer iter;
    _THREAD_STATIC_ doublereal temp, prew, sg2lb, sg2ub, temp1, temp2, dtiim, delsq, 
	    dtiip;
    _THREAD_STATIC_ integer niter;
    _THREAD_STATIC_ doublereal dtisq;
    _THREAD_STATIC_ logical swtch;
    _THREAD_STATIC_ doublereal dtnsq;
    extern /* Subroutine */ int dlaed6_(integer *, logical *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *)
	    , dlasd5_(integer *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *);
    _THREAD_STATIC_ doublereal delsq2, dtnsq1;
    _THREAD_STATIC_ logical swtch3;
    extern doublereal dlamch_(char *);
    _THREAD_STATIC_ logical orgati;
    _THREAD_STATIC_ doublereal erretm, dtipsq, rhoinv;

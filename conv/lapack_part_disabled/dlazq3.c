...
/*  -- LAPACK auxiliary routine (version 3.1) --   
    ...
    /* Local variables */
    _THREAD_STATIC_ doublereal g, s, t;
    _THREAD_STATIC_ integer j4, nn;
    _THREAD_STATIC_ doublereal eps, tol;
    _THREAD_STATIC_ integer n0in, ipn4;
    _THREAD_STATIC_ doublereal tol2, temp;

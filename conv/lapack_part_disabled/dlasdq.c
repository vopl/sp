	...
	doublereal *c__, integer *ldc, doublereal *work, integer *info)
{
    ...
    _THREAD_STATIC_ doublereal r__, cs, sn;
    _THREAD_STATIC_ integer np1, isub;
    _THREAD_STATIC_ doublereal smin;
    _THREAD_STATIC_ integer sqre1;
    extern logical lsame_(char *, char *);
    extern /* Subroutine */ int dlasr_(char *, char *, char *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, integer *), dswap_(integer *, doublereal *, integer *
, doublereal *, integer *);
    _THREAD_STATIC_ integer iuplo;

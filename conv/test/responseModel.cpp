...
{
    //////////////////////////////////////////////////////////////////////////
    ResponseModelLegacy::ResponseModelLegacy()
    {

    }

    namespace ResponseModelLegacy_impl
    {
...
//         }
    ...
    //////////////////////////////////////////////////////////////////////////
    void ResponseModelLegacy::setup(
        real maxT,
        size_t stepsT_l1,
        size_t stepsT_ge1,
        size_t pow)
    ...
    //////////////////////////////////////////////////////////////////////////
    void ResponseModelLegacy::evalVRaw(
        real t, real &rr, real &ri, real &ir, real &ii)
    {
        ...
        ResponseModelLegacy_impl::eval_simple<real>(_pow, t/mp, t, ts, rr_1, ri_1, ir_1, ii_1);
        //ResponseModelLegacy_impl::eval_cosian<real>(_pow, t/mp, t, ts, rr_1, ri_1, ir_1, ii_1);

        real rr_2,ri_2,ir_2,ii_2;
        ResponseModelLegacy_impl::eval_simple<real>(_pow, t/mm, t, ts, rr_2, ri_2, ir_2, ii_2);
...
//     //////////////////////////////////////////////////////////////////////////
//     void ResponseModelLegacy::evalVRaw(const TVReal &t, TVReal &rr, TVReal &ri, TVReal &ir, TVReal &ii)
//     {
//         rr.resize(t.size());
//         ri.resize(t.size());
//         ir.resize(t.size());
...
//     }
    ...
    //////////////////////////////////////////////////////////////////////////
    void ResponseModelLegacy::evalVDRaw(
...
//     }
    ...
    //////////////////////////////////////////////////////////////////////////
    void ResponseModelLegacy::evalVRaw_tabled(
        real logt, 
        real &rr, real &ri, real &ir, real &ii)
    {
        real key;
    ...
    //////////////////////////////////////////////////////////////////////////
    void ResponseModelLegacy::evalVDRaw_tabled(
        real logt, 
        real &rr, real &ri, real &ir, real &ii,
        real &drr, real &dri, real &dir, real &dii)
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    Complex ResponseModelLegacy::eval(real t, real st, const Complex &sv)
    {
        real rr,ri, ir, ii;
    ...
    //////////////////////////////////////////////////////////////////////////
    Complex ResponseModelLegacy::eval_tabled(real logt, real slogt, const Complex &sv)
    {
        real rr,ri, ir, ii;
    ...
    //////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////
    void ResponseModelLegacy::evalFuncOpt(double *p, double *hx, int m, int n, void *_SFuncOptParams)
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    void ResponseModelLegacy::jacoFuncOpt(double *p, double *jx, int m, int n, void *_SFuncOptParams)
    {
        SFuncOptParams *params = (SFuncOptParams *)_SFuncOptParams;
    ...
    static real g_levmarOpts_ResponseModelLegacy[LM_OPTS_SZ] =
    {
        LM_INIT_MU,//mu
    ...
    //////////////////////////////////////////////////////////////////////////
    int ResponseModelLegacy::solve_tv(
...
//         exit(0);
        ...
        memcpy(levmarOpts, g_levmarOpts_ResponseModelLegacy, sizeof(levmarOpts));
    ...
    //////////////////////////////////////////////////////////////////////////
    int ResponseModelLegacy::solve_v(
        size_t eSize, const real *elogt, const Complex *ev,//отклик
...
//         exit(0);
    ...
    //////////////////////////////////////////////////////////////////////////
    void ResponseModelLegacy::dump(const char *fname)
    {
...
int f()
{
    ...
    for(size_t i(0); i<stepsPeriod; i++)
    {
        ...
        Complex v = rm.eval(t, 1, Complex(1,0, CAP));
        out<<t*60*60<<"\t";
        out<<v.re()<<"\t";
        out<<v.im()<<"\n";
        echo.push_back(v);
        logt.push_back(log(t));
    }
    out.flush();

    TVComplex spectr(echo.size());

    TVReal work;

    int res = rm.solve_v(echo.size(), &logt[0],&echo[0], spectr.size(), &logt[0], &spectr[0], 3, work);

...
my $srcDir = '/root/share99/voxforge';
my $dstDir = '/root/share99/voxforge.out_10k_10x';

my $cmdPrefix = '/root/share99/sp-conv-bin/sp-conv --ppw=1 --splp=100 --efmin=0.2 --efmax=20000 --efcount=10000 --eftype=flog --sfminmult=100 --sfmaxmult=1 --sfcountmult=10 --fps=1000 --inititersmax=10 --itersmax=1';
